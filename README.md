...
> [!IMPORTANT]
> Этот раздел не актуален для большинства домашних, т.к. в домашних используется [Github Classroom](https://github.com/MMCS-FIIT/GithubGuide/edit/main/README.md#работа-с-github). Но он может быть полезен для создания личных репозиториев, или для случаев, когда в задании явно указано, что необходимо создать репозиторий с нуля.

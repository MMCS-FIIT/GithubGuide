...
Создайте [файл .gitignore](https://www.toptal.com/developers/gitignore) из тегов как показано на изображении ниже и положите в эту папку. 

![photo_5226792616337282802_x](https://github.com/user-attachments/assets/dc729dea-68e0-47f8-a4fb-1c75f0e0e34b)
...
```
И... Всё! В появивишейся папке вы найдёте все файлы (и коммиты!) из удалённого репозитория, и вы можете продолжать работать с этим репозиторием как обычно. Не забудьте добавить файл [.gitignore](https://www.toptal.com/developers/gitignore), чтобы в репозиторий не попало ничего лишнего!
